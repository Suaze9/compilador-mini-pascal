...
public class BoolAndNode extends BoolPap implements Serializable{
  final int VALUE = 1;
  ...
  public BoolAndNode(Object leftChild, String operator, Object rightChild, int fila, int columna){
    super(fila,columna);
  ...
  public BoolAndNode(boolean not, Object leftChild, String operator, Object rightChild, int fila, int columna){
